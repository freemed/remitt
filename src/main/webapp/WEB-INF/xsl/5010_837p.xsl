...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="/remitt">
		...
		<x12segment sid="GS">
			...
			<element>
				...
				<content><xsl:value-of select="concat(//global/currenttime/hour,//global/currenttime/minute)" />0000</content>
			</element>
			<element>
		...
		<x12segment sid="PER">
			...
			<element>
				<!-- PER01: Contact Function Code [R] -->
				<content>IC</content>
			</element>
			<element>
				<!-- PER02: Submitter Contact Name [S] -->
				<content><xsl:value-of select="translate(//billingcontact/name, $lowercase, $uppercase)" /></content>
			</element>
			<element>
				<!-- PER03: Communication Number Qualifier [R] -->
				<!-- Use telephone number as qualifier -->
				<content>TE</content>
			</element>
			<element>
				<!-- PER04: Communication Number Identifier [R] -->
			...
			<element>
				<!-- PER06: Communication Number Identifier -->
		...
		<x12segment sid="NM1">
			...
			<element>
				<!-- NM108: Identification Code Qualifier [R] -->
				<content>46</content>
			</element>
			<element>
				<!-- NM109: Reciever Primary Identifier [R] -->
			...
			<element>
				<!-- NM112: Name Last or Organization Name [N/U] -->
				<content></content>
			</element>
		</x12segment>
	...
	<xsl:template name="process-practice">
		...
		<xsl:comment>Loop 2000A: Billing Provider Heirarchical Level</xsl:comment>
		...
		<x12segment sid="HL">
			...
			<element>
				<!-- 2000A HL03: Heirarchical level code [R] -->
				<content>20</content>
			</element>
			<element>
				<!-- 2000A HL04: Heirarchical child code [R] -->
				<content>1</content>
			</element>
		</x12segment>
		...
		<x12segment sid="PRV">
			<element>			
				<!-- PRV01: Provider Code [R] -->
				<!-- BI, PT -->
				<content>BI</content>
			</element>
			<element>
				<!-- PRV02: Reference Information Qualifier [R] -->
				<!-- PXC = ? -->
				<content>PXC</content>
			</element>
			<element>
				<!-- PRV03: Provider Taxonomy Code [R] -->
				<!-- TODO: Support this -->
				<content></content>
			</element>
		</x12segment>
		...
		<x12segment sid="NM1">
			...
			<element>
				<!-- 2010A NM102: Entity Type Qualifier (1=person, 2=nonperson) [R] -->
				<content>2</content>
			</element>
			<element>
				<!-- 2010A NM103: Billing Provider Last Or Organizational Name [R] -->
				<content><xsl:value-of select="translate($thispractice/name, $lowercase, $uppercase)" /></content>
			</element>
			<element>
				<!-- 2010A NM104: Billing Provider First Name [S] -->
				<content></content>
			</element>
			<element>
				<!-- 2010A NM105: Billing Provider Middle Name [S] -->
				<content></content>
			</element>
			<element>
				<!-- 2010A NM106: Unused [N/U] -->
				<content></content>
			</element>
			<element>
				<!-- 2010A NM107: Billing Provider Name Suffix [S] -->
				<content></content>
			</element>
			<xsl:if test="boolean(string($thispractice/npi))">
			<element>
				<!-- 2010A NM108: Identification Code Qualifier [S] -->
				<!-- XX = NPI, 24 = EIN, 34 = SSN -->
				<content>XX</content>
			</element>
			<element>
				<!-- 2010A NM109: Billing Provider Primary Identification [S] -->
		...
		<x12segment sid="REF">
			<comment>2010AA REF - Billing Provider Tax Identification</comment>
			<element>
				<!-- 2010AA REF01: Reference Identification Qualifier [R] -->
				<!-- EI = employer identification, SY = ssn -->
				<content>EI</content>
			</element>
			<element>
				<!-- 2010AA REF02: Identification number [R] -->
		...
		<x12segment sid="REF">
			...
			<comment>REF segment for 2000B [S]</comment>
			<element>
				<!-- 2000B REF01: Reference Identification Qualifier [R] -->
				<content><xsl:value-of select="$thispractice/x12idtype" /></content>
			</element>
			<element>
				<!-- 2000B REF02: Billing Provider Additional Identifier [R] -->
		...
		<!-- 2010AB N3: Subscriber Address  -->
		<x12segment sid="N3">
			<element>
				<!-- 2010AB NM301: Subscriber Address Line 1 -->
				<content>
					<xsl:value-of select="translate($thispractice/address/streetaddress, $lowercase, $uppercase)" />
				</content>
			</element>
			<element>
				<!-- 2010AB NM302: Subscriber Address Line 2 -->
				<content></content>
			</element>
		</x12segment>
		...
		<x12segment sid="N4">
			<element>
				<!-- 2010AB NM401: Subscriber City Name -->
				<content><xsl:value-of select="translate($thispractice/address/city, $lowercase, $uppercase)" /></content>
			</element>
			<element>
				<!-- 2010AB NM402: Subscriber State Code -->
				<content><xsl:value-of select="translate($thispractice/address/state, $lowercase, $uppercase)" /></content>
			</element>
			<element>
				<!-- 2010AB NM403: Subscriber Postal Code -->
				<content><xsl:value-of select="$thispractice/address/zipcode" /></content>
			</element>
		</x12segment>

		<!-- 2010AC NM1: Pay to Plan Name [R] -->
		<!-- 2010AC N3: Pay to Plan Address [R] -->
		<!-- 2010AC N4: Pay to Plan City/State/Zip [R] -->
		<!-- 2010AC REF: Pay to Plan Tax Identification [R] -->
...
-->
		...
		<!-- [5010] Removed 2010CA REF segment for SSN -->
